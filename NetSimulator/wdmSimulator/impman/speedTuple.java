...
public final class speedTuple 
{    
    /** Creates a new instance of multiLinearTuple */
    public long nois;
    public int target;
    public int order;
    public speedTuple(long anois,int atarget,int someorder) 
    {
        nois=anois;
        target=atarget;
        order=someorder;
    ...
    public speedTuple clone()
    {
        return new speedTuple(nois,target,order);
    }
}
