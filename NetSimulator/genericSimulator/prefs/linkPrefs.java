...
public class linkPrefs 
{
    ...
    private ArrayList<genericOrientation> listOfGenericOrientations;
    private linkCharacteristics linkCharacteristics;

    @XmlElementWrapper(name = "listOfGenericOrientations")
    @XmlElement(name="genericOrientation")
    public ArrayList<genericOrientation> getListOfGenericOrientations() {
        return listOfGenericOrientations;
    }

    public void setListOfGenericOrientations(ArrayList<genericOrientation> listOfGenericOrientations) {
        this.listOfGenericOrientations = listOfGenericOrientations;
    }

    @XmlElement(name = "linkCharacteristics")
    public linkCharacteristics getLinkCharacteristics() {
        return linkCharacteristics;
    }

    public void setLinkCharacteristics(linkCharacteristics linkCharacteristics) {
        this.linkCharacteristics = linkCharacteristics;
    }
    
    public void checkLogic(networkPrefs top)
    {
        for(genericOrientation gen : this.listOfGenericOrientations)
        {
            gen.checkLogic(top);
        }
        
        this.linkCharacteristics.checkLogic();
    }
