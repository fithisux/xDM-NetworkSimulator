...
@XmlRootElement
public class wdmPrefs 
{
    private boolean impaired;
    private boolean convertible;
    private impairmentPrefs impairmentPrefs; 
    ...
    @XmlElement
    public impairmentPrefs getImpairmentPrefs() {
        return impairmentPrefs;
    }

    public void setImpairmentPrefs(impairmentPrefs impairmentPrefs) {
        this.impairmentPrefs = impairmentPrefs;
    }
    
    public void checkLogic()
    {
        this.impairmentPrefs.checkLogic();
    }
}
