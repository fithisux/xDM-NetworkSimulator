...
import java.util.*;
@XmlRootElement
public class topologyPrefs 
{
    private ArrayList<linkPrefs> listOfLinkPrefs;

    @XmlElementWrapper(name = "listOfLinkPrefs" )
    @XmlElement(name = "linkPrefs")
    public ArrayList<linkPrefs> getListOfLinkPrefs() {
        return listOfLinkPrefs;
    }

    public void setListOfLinkPrefs(ArrayList<linkPrefs> listOfLinkPrefs) {
        this.listOfLinkPrefs = listOfLinkPrefs;
    }
