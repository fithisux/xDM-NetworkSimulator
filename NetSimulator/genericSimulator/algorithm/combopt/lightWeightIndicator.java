 ...
 */
public class lightWeightIndicator   implements Comparator<lightWeightIndicator>
{
    protected long cost;
    protected lightWeightEdge originator; 
    protected lightWeightNode node;
    
    public int compare(lightWeightIndicator n1,lightWeightIndicator n2)
    {
