 ...
 * @author vanag
 */
public class genericComputations 
{
    public List<lightWeightPath> ps;
    public List<genericResource> eqs;
    
    public genericComputations()
    {
        ps=new ArrayList<lightWeightPath>();
        eqs=new ArrayList<genericResource>();
    }
    
    public genericComputations(List<lightWeightPath> p)
    {
        ps=p;
        eqs=new ArrayList<genericResource>();
    }
