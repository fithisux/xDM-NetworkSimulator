...
import genericSimulator.algorithm.genericUnsplitCSPFAlgorithm;
 ...
 * @author vanag
 */
public class ofdmSplitYen extends ofdmSplitCSPF
{
    public ofdmSplitYen(genericRCM rcm)
    {
        super(rcm);  
        this.unsplit=new ofdmUnsplitYen(rcm);
    }
