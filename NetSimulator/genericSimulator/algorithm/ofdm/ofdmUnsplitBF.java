 ...
 * @author vanag
 */
public class ofdmUnsplitBF extends ofdmUnsplitCSPF
{
    public ofdmUnsplitBF(genericRCM rcm)
    {
        super(rcm);
        genericCSPF[] shpa;
        shpa=new genericBellmanFord[this.computations.cspfgraphs.length];
        for(int i=0;i<shpa.length;i++)
        {
            shpa[i]=new genericBellmanFord(this.computations.cspfgraphs[i]);
        }
