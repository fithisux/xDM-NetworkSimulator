...
public class genericPairRequestFactory extends genericVONTrafficGenerator
{
    genericIntPair ie;

    public genericPairRequestFactory(genericIntPair p,genericDistribution[] dists,int someid)
    {
