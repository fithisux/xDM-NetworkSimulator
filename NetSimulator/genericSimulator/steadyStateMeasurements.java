...
public final class steadyStateMeasurements extends genericStateMeasurements
{	
    List<genericEdge> edgefaults;
    public steadyStateMeasurements(genericNMS someNMS,List<genericEdge> edgefaults)
    {
        super(someNMS);
        this.edgefaults=edgefaults;
    }

    public genericSimulationReport updateReport()
    {
        this.nms.reactOnStraightFaults(this.edgefaults);
        genericSimulationReport measure=this.nms.executeMeasurement();
        this.reports.add(measure);
        this.nms.cleanupStraightFaults(this.edgefaults);        
        return measure;
    }         	                                  
}
