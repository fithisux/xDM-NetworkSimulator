...
import genericSimulator.genericStateMeasurements;
 ...
 * @author FITHIS
 */
public class dynamicStateMeasurements extends genericStateMeasurements
{
    public dynamicStateMeasurements(genericNMS someNMS)
    {
        super(someNMS);
    }
