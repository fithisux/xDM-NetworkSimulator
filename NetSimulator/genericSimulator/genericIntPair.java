...
public class genericIntPair
{	
	public int ef,et;
        
        
        public genericIntPair(int x,int y)
	{
            ef=x;
            et=y;
	}
        
        public genericIntPair(genericIntPair p)
	{
            ef=p.ef;
            et=p.et;
	}

        public boolean equals(genericIntPair p)
        {
            return ( (p.ef==ef) && (p.et==et));
        }


        public genericIntPair duplicate()
        {
            return new genericIntPair(ef,et);
        }  
        
        public genericIntPair toggle()
        {
            return new genericIntPair(et,ef);
        }
        
        public String toString()
        {
            String s="A pair ("+(ef)+","+(et)+")";
            return s;
        }
}
